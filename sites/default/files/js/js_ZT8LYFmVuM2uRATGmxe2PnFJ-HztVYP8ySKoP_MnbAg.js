...
(function ($) {
 ...
 Drupal.behaviors.exampleModule = {
  ...
  'use strict'; 
    ...
    var o = function() {
        $("#mainNav").offset(o).top > 100 ? $("#mainNav").addClass("navbar-shrink") : $("#mainNav").removeClass("navbar-shrink")
    };
    o(), $(window).scroll(o), $(".portfolio-modal").on("show.bs.modal", function(o) {
        $(".navbar").addClass("d-none")
    }), $(".portfolio-modal").on("hidden.bs.modal", function(o) {
